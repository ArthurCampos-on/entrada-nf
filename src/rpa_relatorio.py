...
Fluxo completo (baseado em RELATÓRIO.docx):
  1.  Clicar no placeholder da empresa      → campo_empresa
  2.  Digitar "Duna" (filtro)
  3.  Clicar em Duna-Tubarão                → empresa_duna_tubarao
  ...
  8.  Clicar em Imprimir Lista              → btn_imprimir_lista
  9.  Clicar em Sim                         → botao_sim
  10. Apertar Enter
  11. Clicar no ícone de impressão          → botao_icone_impressao_relatorio
  12. Apertar Enter
  13. Aguardar tela do browser              → aba_ipressao_relatorio
  14. Ctrl+P → Enter
"""
...
class RelatorioCompras:
    ...
    def gerar_dia_anterior(self) -> bool:
        """
        Gera o relatório do dia anterior.

        Chamado automaticamente pelo agendador às 8 h ou manualmente via menu.

        Returns:
            True se concluído com sucesso, False em caso de erro.
        """
    ...
    def _passos_1_3_selecionar_empresa(self) -> None:
    ...
    def _passos_4_5_preencher_datas(self, data: str) -> None:
        """
